...
public class C01_InstanceVariables {
    ...
    public static void main(String[] args) {
         ...
         */
        //bu kısım eklemedir(esra)
        staticMethod();//20 getirdi çünkü method içerisinde bir atama yapılmadı
        C01_InstanceVariables obje4=new C01_InstanceVariables();
        obje4.staticOlmayanMethod();//20 yazdırır
        System.out.println(obje4.instSayi);// fakat burda artık 10 olur
    }
