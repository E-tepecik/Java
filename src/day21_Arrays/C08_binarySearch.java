...
public class C08_binarySearch {
    public static void main(String[] args) {
       ...
       // emin olmak icin once sort yapmaliyiz.(KÜÇÜK BÜYÜK HARFE DUYARLIDIR)
       Arrays.sort(harfler);
        System.out.println(Arrays.toString(harfler));
        System.out.println(Arrays.binarySearch(harfler,arananHarf));//"Y" BU ŞEKİLDE YAZINCADA KABUL EDİYOR.(ESRA)
        System.out.println(C03_Contains.contains(harfler,arananHarf));
    }
}