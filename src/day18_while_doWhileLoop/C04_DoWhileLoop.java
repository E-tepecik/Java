...
public class C04_DoWhileLoop {
    public static void main(String[] args) {
        ...
        int sayi=0;//(esra)sürekli variable oluşturmak Scanner string gibi yerlerde remi doldurur.//variable for while içinde kullanırsak dışında kullanamayız. o nedenle loop içerisinde kullnıcağımız variabları loop dışında oluşturmak daha doğrudur.
        // while ile yapalim
        /*
        ...
        }while(sayi%2==0);//şartımız artmaya azalmaya yönelik olmadığı için sornsuz loop oluşmaz.Girilen sayı üzerine şart oluşturduk.girilen sayıda her seferinde değişiyor badidide o nedenle sonsuz loop oluşmaz(esra)
    }
}
