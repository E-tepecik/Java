...
public class C02_Arrays {
    public static void main(String[] args) {
        ...
        System.out.println(sayilar); // [I@58ceff1 //non primitiv data türleri heap'te tutulduğu için stakte referansları vardır.
        // bu nedenle bu şekilde yazdıramıyoruz
        ...
        System.out.println(Arrays.toString(sayilar)); // [0, 0, 0]//bu şekilde yazdırabiliriz.
        sayilar[2]=10;
        sayilar[0]=5;
        sayilar[1]=3;
